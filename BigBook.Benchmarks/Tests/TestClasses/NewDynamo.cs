...
namespace BigBook.Benchmarks.Tests.TestClasses
{
    ...
    public abstract class NewDynamo<TClass> : NewDynamo
        where TClass : NewDynamo<TClass>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        protected NewDynamo(object? item, bool useChangeLog = false)
        ...
        /// </summary>
        /// <param name="useChangeLog">if set to <c>true</c> [use change log].</param>
        protected NewDynamo(bool useChangeLog)
            : base(useChangeLog)
        {
        }
        ...
        public override ICollection<string> Keys
        {
            get
            {
                ...
                foreach (var Property in TypeCacheFor<TClass>.Properties.Where(x => x.DeclaringType != typeof(NewDynamo<TClass>) && x.DeclaringType != typeof(NewDynamo)))
                {
    ...
    /// </summary>
    /// <seealso cref="NewDynamo"/>
    public class NewDynamo : DynamicObject, IDictionary<string, object?>, INotifyPropertyChanged
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewDynamo"/> class.
        /// </summary>
        /// <param name="item">The item.</param>
        /// <param name="useChangeLog">if set to <c>true</c> [use change log].</param>
        public NewDynamo(object? item, bool useChangeLog = false)
            : this(useChangeLog)
        {
            Copy(item);
        }
        ...
        /// </summary>
        /// <param name="useChangeLog">if set to <c>true</c> [use change log].</param>
        public NewDynamo(bool useChangeLog)
            : this()
        {
        ...
        /// </summary>
        public event Action<NewDynamo, string, EventArgs.OnEndEventArgs> GetValueEnd
        {
            add
            {
                getValueEnd_ -= value;
        ...
        /// to the event
        /// </summary>
        public event Action<NewDynamo, EventArgs.OnStartEventArgs> GetValueStart
        {
            add
            {
        ...
        public void Clear()
        {
            ...
            {
                RaisePropertyChanged(Item.Key, Item.Value, null);
            }
            Data.Clear();
        }
        ...
        public override bool Equals(object? obj) => (obj is NewDynamo TempObj) && TempObj.GetHashCode() == GetHashCode();
        ...
        {
            if (!Data.TryGetValue(key, out var OldData))
                return false;
            Data.Remove(key);
            RaisePropertyChanged(key, OldData, null);
            return true;
        }
        ...
        /// <summary>
        /// Returns a subset of the current NewDynamo object
        /// </summary>
        /// <param name="keys">Property keys to return</param>
        /// <returns>A new NewDynamo object containing only the keys specified</returns>
        public dynamic SubSet(params string[] keys)
        {
            var ReturnValue = new NewDynamo(ChangeLog != null);
            if (keys is null)
            {
                return ReturnValue;
            }
        ...
        protected object? GetValue(string name, Type returnType)
        {
            ...
            object? Result = null;
            if (!(Data?.TryGetValue(name, out Result) ?? false))
        ...
        {
            Data.TryGetValue(key, out var OldValue);
            Data.SetValue(key, value);
            if (value != OldValue)
                RaisePropertyChanged(key, OldValue, value);
            return true;
