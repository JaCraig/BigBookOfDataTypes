...
namespace BigBook.Benchmarks.Tests.AltImplementations
{
    /// <summary>
    /// Change class
    /// </summary>
    ...
    public abstract class DynamoAlt<T> : DynamoAlt
        where T : DynamoAlt<T>
    {
        /// <summary>
        /// Constructor
        ...
        protected DynamoAlt(object item, bool useChangeLog = false)
        ...
        protected DynamoAlt(IDictionary<string, object?> dictionary, bool useChangeLog = false)
        ...
        public override ICollection<string> Keys
        {
            get
            {
                ...
                foreach (var Property in TypeCacheFor<T>.Properties.Where(x => x.DeclaringType != typeof(DynamoAlt<T>) && x.DeclaringType != typeof(DynamoAlt)))
                {
    ...
    /// </summary>
    public class DynamoAlt : DynamicObject, IDictionary<string, object?>, INotifyPropertyChanged
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        /// <param name="item">Item to copy values from</param>
        /// <param name="useChangeLog">if set to <c>true</c> [use change log].</param>
        public DynamoAlt(object? item, bool useChangeLog = false)
        {
        ...
        /// <param name="dictionary">Dictionary to copy</param>
        /// <param name="useChangeLog">if set to <c>true</c> [use change log].</param>
        public DynamoAlt(IDictionary<string, object?>? dictionary, bool useChangeLog = false)
        {
        ...
        /// The get value end_
        /// </summary>
        private Action<DynamoAlt, string, EventArgs.OnEndEventArgs>? getValueEnd_;

        /// <summary>
        /// The get value start_
        /// </summary>
        private Action<DynamoAlt, EventArgs.OnStartEventArgs>? getValueStart_;
        ...
        /// </summary>
        public event Action<DynamoAlt, string, EventArgs.OnEndEventArgs> GetValueEnd
        {
            add
            {
                getValueEnd_ -= value;
        ...
        /// to the event
        /// </summary>
        public event Action<DynamoAlt, EventArgs.OnStartEventArgs> GetValueStart
        {
            add
            {
        ...
        protected virtual object? GetValue(string name, Type returnType)
        {
            ...
            if (!ChildValues.TryGetValue(name, out var ChildValueMethod))
            {
                ...
                if (!(Property is null))
                {
                    var Temp = Property.PropertyGetter<DynamoAlt>().Compile();
